				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-center text-sm-left">
						...
						<div class="lang-currency-dropdown">
							<ul>
								<li> <a href="index.html#">English <i class="fa fa-chevron-down"></i></a>
									<ul>
										<li><a href="index.html#">French</a></li>
										<li><a href="index.html#">Japanease</a></li>
									</ul>
								</li>
								<li><a href="index.html#">Dollar <i class="fa fa-chevron-down"></i></a>
									<ul>
								...
								<div class="cart-floating-box" id="cart-floating-box">
									<div class="cart-items">
										<div class="cart-float-single-item d-flex">
											<span class="remove-item"><a href="index.html#"><i class="fa fa-times"></i></a></span>
											<div class="cart-float-single-item-image">
												<a href="single-product.html"><img src="assets/images/products/product01.jpg" class="img-fluid"
														alt=""></a>
											</div>
										...
										<div class="cart-float-single-item d-flex">
											<span class="remove-item"><a href="index.html#"><i class="fa fa-times"></i></a></span>
											<div class="cart-float-single-item-image">
												<a href="single-product.html"><img src="assets/images/products/product02.jpg" class="img-fluid"
														alt=""></a>
											</div>
											<div class="cart-float-single-item-desc">
								...
								<ul>
									...
									<li class="menu-item-has-children"><a href="index.html#">PAGES</a>
										<ul class="mega-menu three-column">
											<li><a href="index.html#">Column One</a>
												<ul>
											...
											<li><a href="index.html#">Column Two</a>
												<ul>
													<li><a href="my-account.html">My Account</a></li>
											...
											<li><a href="index.html#">Column Three</a>
												<ul>
					...
					<div class="tab-slider-wrapper">
						<nav>
							<div class="nav nav-tabs" id="nav-tab" role="tablist">
								<a class="nav-item nav-link active" id="featured-tab" data-toggle="tab" href="index.html#featured" role="tab"
									aria-selected="true">Featured</a>
								<a class="nav-item nav-link" id="new-arrival-tab" data-toggle="tab" href="index.html#new-arrivals" role="tab"
									aria-selected="false">New Arrival</a>
								<a class="nav-item nav-link" id="nav-onsale-tab" data-toggle="tab" href="index.html#on-sale" role="tab"
									...
									<div class="single-tab-slider-item">
										...
										<div class="gf-product tab-slider-sub-product">
											<div class="image">
												...
												<div class="product-hover-icons">
													<a class="active" href="index.html#" data-tooltip="Add to cart"> <span class="icon_cart_alt"></span></a>
													<a href="index.html#" data-tooltip="Add to wishlist"> <span class="icon_heart_alt"></span> </a>
													<a href="index.html#" data-tooltip="Compare"> <span class="arrow_left-right_alt"></span> </a>
													<a href="index.html#" data-tooltip="Quick view" data-toggle="modal"
														data-target="#quick-view-modal-container"> <span class="icon_search"></span> </a>
												</div>
											</div>
										...
										<div class="gf-product tab-slider-sub-product">
											<div class="image">
												...
												<div class="product-hover-icons">
													<a href="index.html#" data-tooltip="Add to cart"> <span class="icon_cart_alt"></span></a>
													<a href="index.html#" data-tooltip="Add to wishlist"> <span class="icon_heart_alt"></span> </a>
													<a href="index.html#" data-tooltip="Compare"> <span class="arrow_left-right_alt"></span> </a>
													<a href="index.html#" data-tooltip="Quick view" data-toggle="modal"
														data-target="#quick-view-modal-container"> <span class="icon_search"></span> </a>
								...
								<div class="col-lg-6 col-md-12">
									...
									<div class="sale-single-product-content text-center">
										...
										<p class="product-description">
											...
											labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco,Proin
											lectus ipsum, gravida et mattis vulputate, tristique ut lectus
										</p>
										<a href="index.html#" class="single-sale-add-to-cart-btn">add to cart</a>
									</div>
				...
				<div class="row">
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-xs-30">
						...
						<div class="single-navigation-section">
							...
							<ul>
								<li> <a href="https://htmldemo.hasthemes.com/greenfarm/greenfarm/about-us.html">About Us</a></li>
					...
					<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 text-center text-md-left">
						...
						<div class="copyright-segment">
							<p>
								...
								<a href="index.html#">Term and conditions</a>
							</p>
								...
								<div class="product-small-image-list">
									<div class="nav small-image-slider" role="tablist">
										<div class="single-small-image img-full">
											<a data-toggle="tab" id="single-slide-tab-1" href="index.html#single-slide1"><img
													src="assets/images/products/product01.jpg" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-toggle="tab" id="single-slide-tab-2" href="index.html#single-slide2"><img
													src="assets/images/products/product02.jpg" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-toggle="tab" id="single-slide-tab-3" href="index.html#single-slide3"><img
													src="assets/images/products/product03.jpg" class="img-fluid" alt=""></a>
										</div>
										<div class="single-small-image img-full">
											<a data-toggle="tab" id="single-slide-tab-4" href="index.html#single-slide4"><img
							...
							<div class="product-feature-details">
								...
								<div class="cart-buttons mb-20">
									...
									<div class="add-to-cart-btn">
										<a href="index.html#"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
									</div>
								</div>
								...
								<div class="social-share-buttons">
									...
									<ul>
										...
										<li><a class="google-plus" href="index.html#"><i class="fa fa-google-plus"></i></a></li>
