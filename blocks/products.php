...
<view>
    <section id="products" class="bg-gray-100">
        <div class="content container">
            <div id="productsCaptions" class="carousel slide" data-ride="carousel" data-keyboard="true" data-touch="true">
                                        ...
                                        <div class="row">
                                                ...
                                                <wb-foreach wb="from=_parent.{{wbTranslit({{_val}})}}"
                                                    ...
                                                    <div class="col-md-3 bd-0">
                                                        <div class="card bd-0">
                                                        <img data-src="/thumb/400x300/src{{images.0.img}}" class="card-img-top" alt="...">
                                                        <div class="card-body">
                                            ...
                                            <div class="col-12">
                                                ...
                                                data-days="7"
                                                data-link="/products/{{id}}/{{wbUrlOnly({{name}})}}" class="mod-cart-add btn btn-success tx-20 px-4 my-3 rounded-30">В корзину <img src="/module/myicons/shopping-cart.svg?size=26&stroke=FFFFFF"></a>
