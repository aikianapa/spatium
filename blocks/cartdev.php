...
<view>
    <div wb-if="'{{_sess.user.id}}' == ''" id="cartLogin">
        ...
        <div class="mb-2 input-group">
            <div class="p-0 col-3 input-group-prepend">
            ...
            <div class="p-0 input-group-append">
                <span class="p-0 cursor-pointer input-group-text" onclick="cartCheckPhone();">
                    <img class="mx-1" data-src="/module/myicons/arrow-right-circle.1.svg?size=30&stroke=10b759" width="30" height="30">
                </span>
            </div>
        </div>
        <div class="mb-2 input-group checkcode d-none">
            <div class="p-0 col-3 input-group-prepend">
            ...
            <div class="p-0 input-group-append">
                <span class="p-0 cursor-pointer input-group-text" onclick="cartLogin();">
    ...
    <form action="#" id="Details" class="{{_var.class}}">
        ...
        <wb-data wb="table=users&item={{_sess.user.id}}">
            <div class="row">
                <div class="mb-2 col-12">
                    ...
                    <p class="py-1 mb-1 tx-12 tx-secondary">Изменить адрес доставки вы можете в
        ...
        <div class="col-12">
            ...
            <div class="row" id="cartButtons">
                <div class="py-1 col-sm-12">
                    <a href="javascript:void(0)" onclick class="cursor-pointer wd-100p checkout-btn btn btn-success rounded-20">Оплата
                        картой</a>
