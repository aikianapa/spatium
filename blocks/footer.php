...
<view>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-xs-30">
						...
						<div class="single-navigation-section">
							...
							<ul>
								...
								<li> <a href="my-account.html#">Terms & Condition</a></li>
							</ul>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-xs-30">
						...
						<div class="single-navigation-section">
							...
							<ul>
								...
								<li> <a href="my-account.html#">Newsletter</a></li>
							</ul>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 mb-xs-30">
						...
						<div class="single-navigation-section">
							...
							<ul>
								...
								<li> <a href="my-account.html#">OUR SERVICE</a></li>
								<li> <a href="my-account.html#">RETURNS</a></li>
								<li> <a href="my-account.html#">SITE MAP</a></li>
							</ul>
						</div>
					...
					<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
						...
						<div class="single-navigation-section">
							...
							<ul>
								...
								<li> <a href="my-account.html#">GIFT VOUCHERS</a></li>
								<li> <a href="my-account.html#">AFFILIATES</a></li>
								<li> <a href="my-account.html#">SPECIALS</a></li>
							</ul>
						</div>
				...
				<div class="row align-items-md-center align-items-sm-center">
					<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 text-center text-md-left">
						...
						<div class="copyright-segment">
							<p>
								<a href="my-account.html#">Privacy Policy</a>
	...
	<!-- Plugins JS -->
	<script type="wbapp">
		wbapp.loadScripts(['assets/js/plugins.js'],'plugins-ready');
		wbapp.on('plugins-ready',function(){
			wbapp.loadScripts(['assets/js/main.js'],'main-ready');
		})
	</script>
</view>