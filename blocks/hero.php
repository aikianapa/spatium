<edit header="Верхняя картинка"><div class="alert alert-info">
...
<div class="form-group row">
        ...
        <div class="col-12">
            ...
            <wb-module wb="module=filepicker&amp;mode=single" name="bkg" wb-path="/assets/images/backgrounds/" wb-ext="webp,jpg,png,jpeg,svg"></wb-module>
        </div>
    </div></edit><view header><section>
    <div class="parallax d-flex" data-img="{{bkg.0.img}}">
        ...
        <div class="parallax-overlay row justify-content-center">
            <div class="col-sm-8 text-center text-center text-white">
                ...
                <a href="%7B%7Blink%7D%7D" wb-if="button &gt; ''" class="btn btn-{{color}} rounded-30 tx-light pd-x-40 pd-y-15 ">
                {{button}}
                </a>
            </div>
        </div>
