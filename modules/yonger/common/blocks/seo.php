...
<view head>
    ...
    <meta property="og:image" content="{{_route.host}}/assets/img/logo.svg">
    ...
    <meta property="image" content="{{_route.host}}/assets/img/logo.svg">
    ...
    <meta itemprop="image" content="{{_route.host}}/assets/img/logo.svg">
