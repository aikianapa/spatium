if (!document.loadedScripts) document.loadedScripts =[];document.loadedScripts.push('/engine/lib/bootstrap/js/bootstrap.bundle.min.js');document.loadedScripts.push('/engine/modules/yonger/tpl/assets/js/dashforge.js');document.loadedScripts.push('/engine/modules/yonger/tpl/assets/js/yonger.js');document.loadedScripts.push('/assets/js/jquery.appear.js');document.loadedScripts.push('/assets/js/counters.js');document.loadedScripts.push('/assets/js/spatium.js');(function($) {/*!
